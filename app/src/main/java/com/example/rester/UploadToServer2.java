...
public class UploadToServer2 extends Activity {
    String myip="",id_customer="",customer,deskripsi,myFILE="";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uploadserver2);
        
        Intent ia = getIntent();
        id_customer = ia.getStringExtra("id_customer");
        ...
        uploadButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog = ProgressDialog.show(UploadToServer2.this, "", "Uploading file...", true);
    ...
    public int uploadFiles(String sourceFileUri) {
        ...
        else
        {
            try {
                ...
                if(serverResponseCode == 200){
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {
                            ...
                            Toast.makeText(UploadToServer2.this, "File Upload Complete.",
                ...
                Intent i = new Intent(UploadToServer2.this,Profile.class);
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        Toast.makeText(UploadToServer2.this, "MalformedURLException", Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        ...
                        Toast.makeText(UploadToServer2.this, "Got Exception : see logcat ",
                                Toast.LENGTH_SHORT).show();
                    }
                });
      ...
      selectedImageUri = Uri.parse(MediaStore.Images.Media.insertImage(getContentResolver(), mPic, getResources().getString(R.string.app_name), Long.toString(System.currentTimeMillis())));*/
        ...
        if(selectedImageUri != null){
            try {
                ...
                // MEDIA GALLERY
                String selectedImagePath = FilePath.getPath(this, selectedImageUri);
