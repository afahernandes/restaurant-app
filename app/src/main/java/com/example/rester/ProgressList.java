...
public class ProgressList extends ListActivity {
...
String id_customer;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
			...
			Intent i = new Intent(getApplicationContext(), Detail_Progress.class);
			i.putExtra("pk", pk);
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(ProgressList.this);
		...
		protected String doInBackground(String... args) {
			...
			params.add(new BasicNameValuePair("status", "Konfirmasi"));
			JSONObject json = jParser.makeHttpRequest(ip+"reservasi/reservasi_show.php", "GET", params);
...
//					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(ProgressList.this, arrayList,R.layout.desain_list, new String[] { TAG_id_reservasi,TAG_atas, TAG_bawah,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
