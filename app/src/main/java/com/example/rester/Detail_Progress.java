...
public class Detail_Progress extends ListActivity {
...
//		}});
	...
	class get extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Detail_Progress.this);
...
//					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(Detail_Progress.this, arrayList,R.layout.desain_list, new String[] { TAG_id_detail,TAG_atas, TAG_bawah,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
	...
	class update extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			List<NameValuePair> params = new ArrayList<NameValuePair>();
			params.add(new BasicNameValuePair("id_reservasi", id_reservasi));
			params.add(new BasicNameValuePair("status", "Selesai"));
		...
		new android.app.AlertDialog.Builder(this)
				...
				.setNeutralButton("Tutup", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dlg, int sumthin) {
						Intent i=new Intent(Detail_Progress.this,Review.class);
