...
public class Detail_Reservasi2 extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.detail_reservasi2);
...
//		}});
		...
		btnProses.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				...
				i.putExtra("pk", id_reservasi);
				i.putExtra("nominal", total);
				i.putExtra("nominal2", total2);
				i.putExtra("upload", "");
				startActivityForResult(i, 100);
	...
	class get extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Detail_Reservasi2.this);
	...
	class update extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			params.add(new BasicNameValuePair("status", "Batal"));
			String url=ip+"reservasi/reservasi_update2.php";
			Log.v("add",url);
...
//					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(Detail_Reservasi2.this, arrayList,R.layout.desain_list, new String[] { TAG_id_detail,TAG_atas, TAG_bawah,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
		...
		new android.app.AlertDialog.Builder(this)
				...
				.setNeutralButton("Tutup", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dlg, int sumthin) {
						Intent i=new Intent(Detail_Reservasi2.this,Menu_utama.class);
						finish();
						startActivity(i);
					}}).show();
	}
