...
public class HistoriList extends ListActivity {
...
String id_customer;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
			...
			Intent i = new Intent(getApplicationContext(), Detail_Histori.class);
			i.putExtra("pk", pk);
	...
	class load extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(HistoriList.this);
		...
		protected String doInBackground(String... args) {
			...
			JSONObject json = jParser.makeHttpRequest(ip+"reservasi/reservasi_showhistori.php", "GET", params);
...
//					startActivity(i);
		...
		protected void onPostExecute(String file_url) {
			...
			runOnUiThread(new Runnable() {
				public void run() {
					ListAdapter adapter = new SimpleAdapter(HistoriList.this, arrayList,R.layout.desain_list, new String[] { TAG_id_reservasi,TAG_atas, TAG_bawah,},new int[] { R.id.kode_k, R.id.txtNamalkp ,R.id.txtDeskripsilkp});
