...
public class Data_RestoranRating extends Activity {
    ...
    class load extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Data_RestoranRating.this);
        ...
        protected void onPostExecute(String file_url) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    gridAdapter = new GridViewAdapter(Data_RestoranRating.this, R.layout.card_product, getData());
                    gridView.setAdapter(gridAdapter);

                    gridView.setOnItemClickListener(new OnItemClickListener() {
                        public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                            ImageItem item = (ImageItem) parent.getItemAtPosition(position);
                            Intent intent = new Intent(Data_RestoranRating.this, Detail_restaurant.class);
